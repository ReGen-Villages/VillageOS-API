...
└── src/
    ...
    │   ├── intakeWizard.ts      # The draft, the area units, the programme split, the parcel boundary and the posted document
