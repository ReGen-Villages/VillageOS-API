...
// panel width, or i18n reading the persisted language) crash the whole test
// file before any test runs. Provide a minimal in-memory shim so any test that
// touches such modules just works.
