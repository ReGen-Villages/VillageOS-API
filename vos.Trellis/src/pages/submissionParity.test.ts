...
/**
 * Every `submissions` subcommand the command line answers to has a row in the Field Guide's console-and-
...
describe('the parity table lists every submissions command', () => {
  const parityTable = readFileSync(join(REPOSITORY, 'docs', 'FIELD_GUIDE.md'), 'utf-8');
