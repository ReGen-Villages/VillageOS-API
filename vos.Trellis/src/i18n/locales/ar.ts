...
export const ar: WithArabicPluralForms<Resources> = {
  ...
  pipeline: {
    ...
    noServicesBody: "حمّل نموذجًا يحتوي على اتصالات مُسجّلة (مثل بذرة العرض التوضيحي لخط المعالجة) — تظهر في المخرجات على اليمين، تحت الخدمات، كعُقد يمكنك إضافتها.",
