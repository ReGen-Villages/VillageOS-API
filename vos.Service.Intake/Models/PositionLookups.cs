...
// A position somebody clicked, asked about before any site exists — which is why the answer
...
// record it is — the register's own credit line, which the page that draws the boundary displays.
