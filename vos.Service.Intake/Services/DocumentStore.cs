...
/// <summary>What the store kept of one file: the key it is kept under and how many bytes it holds.</summary>
...
public sealed class DocumentStore(string directory)
{
    ...
    /// <summary>Keeps the bytes under a key of the store's own: the name a person gave the file is a
    ...
    /// <summary>The submissions whose files are kept, read off the folders.</summary>
    ...
    /// <summary>Takes a submission's files out, whole. Nothing is kept of a submission the model has let go.</summary>
