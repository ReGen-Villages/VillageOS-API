...
// How a verification code reaches the address it was made for.
// One method, because that is the whole of what this service asks of mail. A deployment whose
// server wants something this cannot do — a token exchange rather than a password, say — is one
// implementation of this, and nothing else here changes.
...
{
    // What the code arrives as. Separate from the sending because this is the part worth
    // checking: what a message carries is a decision, and handing it to a server is not.
    ...
    // What to relay under, or null where the server asks for nothing. Separate because relaying
