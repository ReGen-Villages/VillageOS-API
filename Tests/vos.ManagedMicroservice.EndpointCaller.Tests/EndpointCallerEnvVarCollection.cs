...
// Tests that read or mutate the ENDPOINTCALLER_* environment variables share this collection
...
[CollectionDefinition(nameof(EndpointCallerEnvVarCollection), DisableParallelization = true)]
public class EndpointCallerEnvVarCollection { }
