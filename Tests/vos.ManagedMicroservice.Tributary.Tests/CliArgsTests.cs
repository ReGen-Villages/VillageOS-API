...
// CliArgs.Parse now falls back to TRIBUTARY_* env vars (so WebApplicationFactory<Program>
...
public class CliArgsTests : IDisposable
{
    ...
    {
        "TRIBUTARY_PORT", "TRIBUTARY_BROKER_URL",
        "TRIBUTARY_TOKEN", "TRIBUTARY_SIGNING_KEY",
        "TRIBUTARY_ISSUER", "TRIBUTARY_AUDIENCE"
    };
    ...
    {
        Environment.SetEnvironmentVariable("TRIBUTARY_PORT", "7100");
        Environment.SetEnvironmentVariable("TRIBUTARY_BROKER_URL", "http://from-env");
    ...
    {
        Environment.SetEnvironmentVariable("TRIBUTARY_PORT", "1111");
        Environment.SetEnvironmentVariable("TRIBUTARY_BROKER_URL", "http://env-broker");
    ...
    {
        Environment.SetEnvironmentVariable("TRIBUTARY_PORT", "5100");
        Environment.SetEnvironmentVariable("TRIBUTARY_BROKER_URL", "http://broker");
        Environment.SetEnvironmentVariable("TRIBUTARY_TOKEN", "env-token");
        Environment.SetEnvironmentVariable("TRIBUTARY_SIGNING_KEY", "env-key");
        Environment.SetEnvironmentVariable("TRIBUTARY_ISSUER", "env-issuer");
        Environment.SetEnvironmentVariable("TRIBUTARY_AUDIENCE", "env-audience");
