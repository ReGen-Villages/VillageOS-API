...
The microservice test projects currently mix Moq and NSubstitute (Moq in CLI/Metabolism, NSubstitute in EndpointCaller/IntegrationRegistry). Converging on one is out of scope for the test-coverage Feature (#5394) — tracked in `docs/TEST-STATE.md` Watch items #4.
