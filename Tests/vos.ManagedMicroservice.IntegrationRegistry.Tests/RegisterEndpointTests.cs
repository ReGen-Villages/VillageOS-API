...
// vos.ManagedMicroservice.IntegrationRegistry/Program.cs. Each test wires a per-scenario
...
public class RegisterEndpointTests
{
    ...
    public async Task Health_ReturnsHealthy()
    {
        ...
        body.Should().Contain("IntegrationRegistry");
    }
    ...
    public async Task Shutdown_Returns200WithMessage()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.OK);
        (await response.Content.ReadAsStringAsync()).Should().Contain("Shutting down IntegrationRegistry");
    }
