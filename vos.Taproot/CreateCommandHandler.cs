...
{
    public class CreateCommandHandler : CommandHandlerWithOutputOptions
    {
        public CreateCommandHandler(string arg, TextWriter writer, MyceliumClient mycelium, OutputOptions? options = null)
