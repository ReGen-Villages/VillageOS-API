...
public static class ReportedCommandLine
{
    public const string Mask = "****";

    private static readonly Regex SensitiveName = new("password|secret|token|key", RegexOptions.IgnoreCase);

    private static readonly Regex NamedValue = new("^(?<name>-{0,2}[^=\\s]+)=.+$");
