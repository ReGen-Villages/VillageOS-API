...
{
    public class FindCommandHandler : CommandHandlerWithOutputOptions
    {
        public FindCommandHandler(string arg, TextWriter writer, MyceliumClient mycelium, OutputOptions? options = null)
