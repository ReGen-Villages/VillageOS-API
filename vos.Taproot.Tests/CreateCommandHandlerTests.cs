...
public class CreateCommandHandlerTests
{
    ...
    {
        var handler = new CreateCommandHandler("thing", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateRelation_ValidIds_CreatesRelationship()
    {
        ...
        _myceliumMock.Setup(b => b.CreateRelationshipAsync(subjectId, predicateId, targetId)).ReturnsAsync(json);

        var handler = new CreateCommandHandler($"relation {subjectId} {predicateId} {targetId}", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();

        _myceliumMock.Verify(b => b.CreateRelationshipAsync(subjectId, predicateId, targetId), Times.Once);
    ...
    public async Task CreateRelation_InvalidSubjectName_ShowsError()
    {
        ...
        var handler = new CreateCommandHandler($"relation not-a-thing {Guid.NewGuid()} {Guid.NewGuid()}", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateRelation_WithNames_CreatesRelationship()
    {
        ...
        var handler = new CreateCommandHandler("relation Subject Predicate Target", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateRelation_WithAmbiguousName_ShowsError()
    {
        ...
        var handler = new CreateCommandHandler($"relation Duplicate Other {Guid.NewGuid()}", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    {
        var handler = new CreateCommandHandler("relation onlyOneArg", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    {
        var handler = new CreateCommandHandler("property onlyOneArg", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    {
        var handler = new CreateCommandHandler("unknownsubcommand", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateRelation_WithShowGuidsFlag_ShowsGuids()
    {
        ...
        var handler = new CreateCommandHandler("relation Subject Predicate Target --showguids", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateProperty_WithShowGuidsFlag_ShowsGuid()
    {
        ...
        var handler = new CreateCommandHandler("property MyThing TestProp System.String TestValue --showguids", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateRelation_InvalidPredicateName_ShowsError()
    {
        ...
        var handler = new CreateCommandHandler($"relation Subject NonExistentPredicate Target", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateRelation_InvalidTargetName_ShowsError()
    {
        ...
        var handler = new CreateCommandHandler($"relation Subject Predicate NonExistentTarget", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    {
        var handler = new CreateCommandHandler("relation arg1 arg2", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateRelation_MixedGuidsAndNames_Works()
    {
        ...
        var handler = new CreateCommandHandler($"relation {subjectId} Predicate {targetId}", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateRelation_DisplaysNamesInOutput()
    {
        ...
        var handler = new CreateCommandHandler("relation Alice likes Bob", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    public async Task CreateProperty_InvalidThingName_ShowsError()
    {
        ...
        var handler = new CreateCommandHandler("property NonExistent TestProp System.String Value", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
    ...
    {
        var handler = new CreateCommandHandler("property arg1 arg2 arg3", _writer, _myceliumMock.Object);
        await handler.ExecuteAsync();
