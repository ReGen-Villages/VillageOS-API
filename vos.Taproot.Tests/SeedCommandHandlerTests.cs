...
public class SeedCommandHandlerTests
{
    ...
    {
        var handler = new SeedCommandHandler(arg, _writer, _myceliumMock.Object);
    ...
    {
        _myceliumMock.Setup(b => b.GetSeedStatusAsync()).ReturnsAsync(Parse("{\"loaded\":2}"));
    ...
    {
        _myceliumMock.Setup(b => b.ListLibrarySeedsAsync()).ReturnsAsync(Parse("[]"));
    ...
    {
        _myceliumMock.Setup(b => b.ListLibrarySeedsAsync())
    ...
    [Fact]
    public async Task Load_DelegatesToMycelium_PrintsConfirmation()
    {
        _myceliumMock.Setup(b => b.LoadLibrarySeedAsync("forest")).ReturnsAsync(Parse("{}"));
        ...
        _myceliumMock.Verify(b => b.LoadLibrarySeedAsync("forest"), Times.Once);
    }
    ...
    [Fact]
    public async Task Save_DelegatesToMycelium_PrintsConfirmation()
    {
        _myceliumMock.Setup(b => b.SaveLibrarySeedAsync("village")).ReturnsAsync(Parse("{}"));
        ...
        _myceliumMock.Verify(b => b.SaveLibrarySeedAsync("village"), Times.Once);
    }

    [Fact]
    public async Task Reload_DelegatesToMycelium_PrintsConfirmation()
    {
        _myceliumMock.Setup(b => b.ReloadSeedsAsync()).ReturnsAsync(Parse("{}"));
