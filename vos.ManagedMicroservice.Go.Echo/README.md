...
This is the Go analogue of the canonical C# [`vos.ManagedMicroservice.CSharp.Echo`](../vos.ManagedMicroservice.CSharp.Echo) example — an **echo handler**: `/handle` acknowledges the relationship and reflects the payload back. Replace the body of `handleRelationship` in `main.go` with your predicate logic.
