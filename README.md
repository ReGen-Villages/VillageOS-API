...
The same documentation is published to the [VillageOS API Wiki](https://github.com/ReGen-Villages/VillageOS-API/wiki), which is **generated from the files in `docs/`** on every merge to main — edit the file, never the wiki page. See [tools/docs-to-wiki](tools/docs-to-wiki/).

Key pages:

- [Trellis](https://github.com/ReGen-Villages/VillageOS-API/wiki/Trellis) — visualization stack, tech spec, user guide
- [Taproot](https://github.com/ReGen-Villages/VillageOS-API/wiki/Taproot) — command reference
