namespace vos.ManagedMicroservice.IntegrationRegistry.Configuration;

/// <summary>
/// Parsed command-line arguments for the IntegrationRegistry service.
/// </summary>
    ...
    string? Audience = null)
{
    ...
    /// Falls back to INTEGRATIONREGISTRY_PORT / INTEGRATIONREGISTRY_BROKER_URL /
    /// INTEGRATIONREGISTRY_TOKEN / INTEGRATIONREGISTRY_SIGNING_KEY / INTEGRATIONREGISTRY_ISSUER /
    /// INTEGRATIONREGISTRY_AUDIENCE environment variables for any flag not present in args.
    ...
    public static CliArgs? Parse(string[] args)
    {
        ...
        var portStr = FromArgsOrEnv("--port=", "INTEGRATIONREGISTRY_PORT");
        var brokerUrl = FromArgsOrEnv("--brokerUrl=", "INTEGRATIONREGISTRY_BROKER_URL");
        ...
        var token = FromArgsOrEnv("--token=", "INTEGRATIONREGISTRY_TOKEN");
        var signingKey = FromArgsOrEnv("--signingKey=", "INTEGRATIONREGISTRY_SIGNING_KEY");
        var issuer = FromArgsOrEnv("--issuer=", "INTEGRATIONREGISTRY_ISSUER");
        var audience = FromArgsOrEnv("--audience=", "INTEGRATIONREGISTRY_AUDIENCE");
