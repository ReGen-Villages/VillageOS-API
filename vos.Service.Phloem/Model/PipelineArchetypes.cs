...
// The role each archetype plays, as a flag the archetype carries.
//
...
public static class PipelineArchetypes
{
    ...
    // archetype is looked up at the point of writing rather than read off the pipeline.
    ...
    // Refuse a model that marks a role played in resolving a DAG on no archetype at all. Left
    // unmarked, every question this orchestrator asks of the snapshot answers "no", and a pipeline that
    // is fully described in the model reads as one with nothing in it.
